    ...
    >
      <div className="container-custom">
        <div className="flex items-center justify-between">
          ...
          >
            <div className="w-10 h-10 rounded-full bg-finpro-gold flex items-center justify-center">
                  ...
                  <Link
                    ...
                    className={cn(
                      ...
                      location.pathname === link.path
                        ? 'text-finpro-gold font-semibold'
                        : 'text-gray-700 hover:text-finpro-gold'
                    )}
                  >
                    {link.title}
                  </Link>
          ...
          >
            {isMenuOpen ? (
              <X className="w-6 h-6 text-finpro-gold" />
            ) : (
              <Menu className="w-6 h-6 text-finpro-gold" />
            )}
          </button>
        </div>
      </div>
