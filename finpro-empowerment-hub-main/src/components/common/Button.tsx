...
const Button = ({ 
  ...
  const variantClasses = {
    ...
    outline: "border-2 border-finpro-gold text-finpro-gold hover:bg-finpro-gold/10 focus:ring-2 focus:ring-finpro-gold/50",
    ghost: "text-finpro-gold hover:bg-finpro-gold/10 focus:ring-2 focus:ring-finpro-gold/50"
  };
