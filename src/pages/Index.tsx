...
const Index = () => {
  ...
  const sponsors = [
    { name: "Sponsor 1", logo: "https://via.placeholder.com/150x80?text=Sponsor+1" },
    { name: "Sponsor 2", logo: "https://via.placeholder.com/150x80?text=Sponsor+2" },
    { name: "Sponsor 3", logo: "https://via.placeholder.com/150x80?text=Sponsor+3" },
          ...
          <div className="flex flex-wrap justify-center items-center gap-8 mb-12">
            {sponsors.map((sponsor, index) => (
              <FadeIn key={index} delay={100 * (index + 1)}>
                <div className="w-36 h-20 bg-gray-50 rounded-lg flex items-center justify-center p-4 grayscale hover:grayscale-0 transition-all duration-300">
